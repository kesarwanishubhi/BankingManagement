...
#define ADMIN_PASSWORD_FILE "./records/admin_password.bank"
...
//#define CUSTOMER_FILE "customer_file.txt"  // The file storing customer details
#define INSUFFICIENT_FUNDS   "INSUFFICIEN FUNDS"

//#define ACCOUNT_ID_DOESNT_EXIT "Account ID does not exist!\n"
//#define GET_ACCOUNT_NUMBER "Please provide the account number:\n"
...
//#define TRANSACTIONS_NOT_FOUND "No transactions found for this customer!\n"
...
struct Feedback {
    ...
    char feedbackText[500];     // Customer's feedback (can be expanded as needed)
    time_t feedbackDate;        // Timestamp of when the feedback was submitted
};
*/
// ==========================================================================================
#define ACCOUNT_FILE "../ACCOUNT_FILE"
#define CUSTOMER_FILE "/home/tushar/Banking/CUSTOMER_FILE"
#define TRANSACTION_FILE "../TRANSACTION_FILE"
#define LOAN_FILE "../LOAN_FILE"

//#define LOAN_APPLICATION_FILE "./records/loan_applications.bank"
...
//#define ACCOUNT_ID_DOESNT_EXIT "No account found with the provided account number.\n"
...
// MANAGER LOGOUT
#define MANAGER_LOGOUT "Logging you out now manager! Goodbye!$"
// ROLES
